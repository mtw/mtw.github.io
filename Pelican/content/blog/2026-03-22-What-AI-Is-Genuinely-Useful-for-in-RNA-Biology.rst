...
So if I had to summarize the current situation in one sentence, it would be this: AI is most useful in RNA biology when it accelerates a problem we already understand how to pose. It is least useful when it is asked to hide the fact that the question itself has not yet been made precise.
