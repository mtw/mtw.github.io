...
Comparative RNA analysis therefore has to look for something different. Instead of asking only which segments stay similar letter by letter, it asks whether the same architectural idea has been preserved. Are stems maintained through compensatory substitutions. Do different lineages reuse the same arrangement of motifs even when the local sequence has changed. Does a conserved mechanistic role survive despite obvious divergence.
