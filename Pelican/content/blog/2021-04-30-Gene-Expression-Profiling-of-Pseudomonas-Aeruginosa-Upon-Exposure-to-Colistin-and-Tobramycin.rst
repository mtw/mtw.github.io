...
This study also fits well into the broader *Pseudomonas* cluster on the site. The 2016 anoxic CF-sputum transcriptomics paper looked at how the infection-like environment reshapes physiology over time. This 2021 work asks what happens when that already adapted physiology is hit with last-resort antibiotics. And the later Hfq/Crc/CrcZ papers approach related questions from a regulatory angle, asking how metabolic and post-transcriptional control feed into drug susceptibility. Together, these papers show that antibiotic response in *Pseudomonas* is tightly interwoven with metabolism, envelope state, and translational control.
