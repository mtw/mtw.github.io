...
:date: 2024-05-29
:modified: 2024-09-30
:tags: virus bioinformatics; molecular epidemiology; One Health; xrRNA; flavivirus
...
:description: Xinyang flavivirus (XiFV), from Haemaphysalis flava ticks in China, defines a basal, likely tick-only orthoflavivirus lineage and keeps the xrRNA 3′UTR.
...
This connects naturally to the earlier :link-flat:`Mpulungu virus study <{filename}/blog/2021-03-01-An_African_Tick_Flavivirus_Forming_an_Independent_Clade_Exhibits_Unique_Exoribonuclease-Resistant_RNA_Structures_in_the_Genomic_three_prime-Untranslated_Region.rst>`, which first established the unusual African branch and identified distinctive xrRNA-like features in its 3' UTR. XiFV strengthens that story by showing that the lineage is broader than MPFV alone and by adding another genome against which the structural and ecological hypotheses can be tested. It also sits well beside the :link-flat:`Zambia insect-specific flavivirus xrRNA work <{filename}/blog/2020-09-14-Discoveries-of-Exoribonuclease-Resistant-Structures-of-Insect-Specific-Flaviviruses-Isolated-in-Zambia.rst>`, where the emphasis was likewise on how non-coding RNA structure helps reveal deeper commonalities across understudied flavivirus groups.
